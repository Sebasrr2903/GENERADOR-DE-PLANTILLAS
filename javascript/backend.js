 function toggleCalculadora() {
  ...
  function accesoRapido(texto) {
    ...
    const plantillas = {
      ...
      //RECHAZOS
      "Rechazo por ND": "Buen día,\n\nLes informo que se ha realizado una modificación en la política de visto bueno de Condenación. A partir de la fecha 22 de abril del 2026.\n\nTodo visto bueno que cuente con reversión por no concretar venta y que requiera volver a gestionar la operación, deberá contar previamente con el visto bueno por medio de correo electonicio de Operaciones Comerciales antes de solicitar el visto bueno a Soporte Comercial, en caso de no contar con este visto bueno, el caso no podrá ser procesado y será rechazado.\n\n\n¡Nos encantó atenderte el día de hoy!\nSu número de gestión es:{gestion}\nAnte cualquier duda o inconveniente que tengás podés comunicarte a los siguientes medios:\n📱 WhatsApp: 7002 4600\n¡Qué pases un excelente día!.",
      ...
      "SIN INFOMACIÓN": "Buen día,\n\nEl caso se rechaza por no venir la plantilla completa. Deben completarla y enviarla junto con la cédula del cliente por ambos lados.Buenas tardes\nSu apoyo con la validación del caso\nNombre del cliente: xxxxxxxxxxx\nCédula del cliente: xxxxxxxxxxx\nSolicitud visto bueno\nNombre del DTS:\n\nCualquier duda adicional con gusto.\n\n\n¡Nos encantó atenderte el día de hoy!\nSu número de gestión es:{gestion}\nAnte cualquier duda o inconveniente que tengás podés comunicarte a los siguientes medios:\n📱 WhatsApp: 7002 4600\n¡Qué pases un excelente día!.",
