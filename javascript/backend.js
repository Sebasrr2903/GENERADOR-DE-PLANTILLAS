 function toggleCalculadora() {
  ...
  function accesoRapido(texto) {
    ...
    const plantillas = {
      ...
      //RECHAZOS
      "Rechazo por ND": "Buen día,\n\nPara poder proceder con el caso, se requiere el visto bueno de Operaciones Comerciales, ya que el cliente cuenta con una reversión reciente de una limpieza realizada el //2026.Sin este visto bueno, no es posible continuar con el análisis solicitado.\n\n\n¡Nos encantó atenderte el día de hoy!\nSu número de gestión es:{gestion}\nAnte cualquier duda o inconveniente que tengás podés comunicarte a los siguientes medios:\n📱 WhatsApp: 7002 4600\n¡Qué pases un excelente día!.",
